    ...
    >
      <KeyboardAvoidingView style={styles.background}>
        <View style={styles.containerLogo}>
          ...
          <Text style={styles.txtLogin}>Crie sua conta</Text>
          <Text style={styles.descriptionLogin}>Cadastre-se para continuar</Text>
        </View>
...
{/* 
          ...
          <SafeAreaView style={styles.viewCad}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('HomeScreen')}>
              <Text style={styles.txtCad}>Faça login</Text>
            </TouchableOpacity>
          </SafeAreaView>
        </Animated.View>
      </KeyboardAvoidingView>
